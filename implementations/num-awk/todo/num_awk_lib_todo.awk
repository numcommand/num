###
#
# num.awk: number utilties for mathematics, as an awk library.
#
###
...
function population_variance(arr) {
    return sum_of_mean_deviation_exp_over_x(arr, 2, n(arr))
}
...
#     1 2 4 => 2.33333
#
function sample_variance(arr) {
    return sum_of_mean_deviation_exp_over_x(arr, 2, n(arr) - 1)
}
...
#     1 2 4 => 1.24722
#
function population_standard_deviation(arr) {
...
#     1 2 4 => 1.52753
#
function sample_standard_deviation(arr) {
...
#     1 2 4 => 0.534522
#
function population_coefficient_of_variance(arr) {
    return population_standard_deviation(arr) / mean(arr)
}
...
#     1 2 4 => 0.654654
#
function sample_coefficient_of_variance(arr) {
    return sample_standard_deviation(arr) / mean(arr)
}
